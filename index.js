...
const sessdata = session.replace("TECH WORLD 401", '');
...
async function startRaven() {
  ...
  console.log(
    color(
      figlet.textSync("TECH-WORLD-401", {
        font: "Standard",
...
startRaven()
      ...
      console.log(color("Congrats, TECH WORLD 401has successfully connected to this server", "green"));
      console.log(color("Follow me on github as Courtney 255", "red"));
      console.log(color("Text the bot number with menu to check my command list"));
      client.groupAcceptInvite('GrpZBqZ5QUYH6mx8HCTP1Q?');
      const Texxt = `�? 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 » »【BTECH WORLD 401】\n`+`👥 𝗠𝗼𝗱𝗲 »» ${mode}\n`+`👤 𝗣𝗿𝗲𝗳𝗶𝘅 »» ${prefix}`
